      ...
      <div>
        ...
        <div className="App">
          ...
          <div className="App-playlist">
            ...
            <Playlist onSave={this.savePlaylist} onNameChange={this.updatePlaylistName} onRemove={this.onRemove} playlistName={this.state.playlistName} playlistTracks={this.state.playlistTracks} />
          </div>
        </div>
      </div>
    );
